...
import { useGetNotificationQuery, useMarkNotificationMutation } from '../redux/slices/api/userApiSlice';
...
const NotificationPanel = () => {
  ...
  const [markasRead]=useMarkNotificationMutation();
  ...
  const viewHandler = async(element) => {
       setSelected(element)
        readHandler("one", element._id)
        setOpen(true);
  };
